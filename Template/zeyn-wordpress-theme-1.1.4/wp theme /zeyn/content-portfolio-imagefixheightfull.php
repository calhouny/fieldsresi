...
if($featured_image){
	$image=aq_resize($featured_image[0], 0,$imageSize, false, false);
}
...
<div class="post-image-container">
	...
	<div class="post-image">
		<img class="simg-responsive" data-width="<?php print $image[1];?>" width="<?php print $image[1];?>" data-height="<?php print $image[2];?>" src="<?php echo $image[0]; ?>" alt="<?php the_title();?>" />
	</div>
	<?php endif;?>
