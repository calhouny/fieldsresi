    ...
    if ($this->field['font-family'] == true):
          ...
          echo '<div id="'.$this->field['id'].'" class="redux-typography-container" data-id="'.$this->field['id'].'" data-units="'.$unit.'">';
              ...
              if ( isset($this->field['update_weekly']) && $this->field['update_weekly'] == true && $this->field['google'] == true && !empty( $this->args['google_api_key'] ) ) {
                  ...
                  if( $wp_filesystem->exists( DethemeReduxFramework::$_dir.'inc/fields/typography/googlefonts.html' )) {
                    ...
                    if ( $last_updated < $weekback ) {
                      $wp_filesystem->delete( DethemeReduxFramework::$_dir.'inc/fields/typography/googlefonts.html' );
                      $wp_filesystem->delete( DethemeReduxFramework::$_dir.'inc/fields/typography/googlefonts.json' );
                    }                 
                  }
              }
              ...
              if ($this->field['google'] == true && !empty( $this->args['google_api_key'] ) ) {
                  ...
                  } elseif( $wp_filesystem->exists( DethemeReduxFramework::$_dir.'inc/fields/typography/googlefonts.html' )) {
